...
where the averages for Group-Male are $\mu_{A-M} = 24.6908$, $\mu_{B-M} = 23.1251$, $\mu_{C-M} = 23.4618$, and $\mu_{D-M} = 22.8479$; the averages for Group-Female are $\mu_{A-F} = 26.4927$, $\mu_{B-F} = 24.927$, $\mu_{C-F} = 25.2637$, and $\mu_{D-F} = 24.6498$.
